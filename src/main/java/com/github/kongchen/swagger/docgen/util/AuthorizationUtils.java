...
public class AuthorizationUtils {
    ...
    private static List<AuthorizationScope> mergeScopes(scala.collection.immutable.List<AuthorizationScope> authorizationScopes,
            scala.collection.immutable.List<AuthorizationScope> newScopes) {
